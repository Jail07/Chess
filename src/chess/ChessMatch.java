...
public class ChessMatch {
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
        ...
        if (testCheck(currentPlayer)) {
            ...
            throw new ChessException("Вы не можете поставить себя под шах.");
        }
    ...
    public ChessPiece replacepromotedPiece(String type){
        if(promoted == null){
            throw new IllegalStateException("Вы выбрали фигуру, которая вам не принадлежит.");
        }
        if(!type.equals("R") && !type.equals("Q") && !type.equals("H") && !type.equals("G")){
            throw new InvalidParameterException("Неверный тип фигуры для продвижения.");
        }
    ...
    private ChessPiece newPiece(String type, Color color) {
        if (type.equals("G")) return new Goose(board, color);
    ...
    private void validateSourcePosition(Position position) {
        ...
        if (currentPlayer != ((ChessPiece) board.piece(position)).getColor()) {
            throw new ChessException("Вы выбрали фигуру, которая вам не принадлежит.");
        }
        if (!board.piece(position).isThereAnyPossibleMove()) {
            throw new ChessException("У выбранной фигуры нет доступных ходов.");
        }
    }
    ...
    private ChessPiece king(Color color) {
        ...
        throw new IllegalStateException("Не найден король с цветом " + color);
    }
    ...
    private void initialSetup() {
        ...
        placeNewPiece('c', 1, new Goose(board, Color.WHITE));
        placeNewPiece('d', 1, new Queen(board, Color.WHITE));
        placeNewPiece('e', 1, new JK(board, Color.WHITE, this));
        placeNewPiece('f', 1, new Goose(board, Color.WHITE));
        ...
        placeNewPiece('c', 8, new Goose(board, Color.BLACK));
        placeNewPiece('d', 8, new Queen(board, Color.BLACK));
        placeNewPiece('e', 8, new JK(board, Color.BLACK, this));
        placeNewPiece('f', 8, new Goose(board, Color.BLACK));
